		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CheckListREcibidos",
									"targetURL": "#CheckListREcibidos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CheckListREcibidos-display": {
								"semanticObject": "CheckListREcibidos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=checklistRec.ChecklistRecibidos",
									"url": sap.ui.require.toUrl("checklistRec/ChecklistRecibidos")
								}
							}
						}
					}
