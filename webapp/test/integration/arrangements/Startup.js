sap.ui.define([
	"sap/ui/test/Opa5",
	"checklistRec/ChecklistRecibidos/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("checklistRec.ChecklistRecibidos.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "checklistRec.ChecklistRecibidos",
					async: true
				},
				hash: oOptions.hash,
